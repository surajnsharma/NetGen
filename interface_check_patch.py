#!/usr/bin/env python3
"""
Create a minimal patch to add interface status check to ARP API
"""

def create_patch():
    """Create a patch file for the interface check."""
    
    patch_content = '''--- a/run_tgen_server.py
+++ b/run_tgen_server.py
@@ -3419,6 +3419,30 @@ def get_device_arp_status(device_id):
             }), 200
...
'''
    ...
    with open('interface_check.patch', 'w') as f:
        f.write(patch_content)
    
    print("✅ Patch file created: interface_check.patch")
